...
png("./Data/Plot4.png", width = 480, height = 480, units = "px", bg = FALSE)

### Creates a two dimentional plotting cavas (two rows and two colunms).
par(mfrow = c(2, 2))

# Creates plot in the topleft.
plot(subseted_house_power_consumption$Full_Date, subseted_house_power_consumption$Global_active_power, type = "l", xlab = "", ylab = "Global Active Power")

# Creates plot in the topright.
plot(subseted_house_power_consumption$Full_Date, subseted_house_power_consumption$Voltage, type = "l", xlab = "datetime", ylab = "Voltage")


# Creates the plot in the bottomleft. 
...
# Creates the legend for the plot in the bottomleft.
legend("topright", c("Sub_metering_1", "Sub_metering_2", "Sub_metering_3"), lty = 1, lwd = 1, col = c("black", "red", "blue"), bty = "n")

# Creates the legend for the plot in the bottomright.
plot(subseted_house_power_consumption$Full_Date, subseted_house_power_consumption$Global_reactive_power, type = "l", xlab = "datetime", ylab = "Global_reactive_power")
